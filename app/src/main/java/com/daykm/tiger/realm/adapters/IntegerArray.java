...
public class IntegerArray extends TypeAdapter<RealmList<IntegerWrapper>> {
    ...
    @Override
    public void write(JsonWriter out, RealmList<IntegerWrapper> value) throws IOException {

    }

    @Override
    public RealmList<IntegerWrapper> read(JsonReader in) throws IOException {
