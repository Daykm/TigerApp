...
public class UpdateStatusDialog extends DialogFragment {
    ...
    @BindView(R.id.character_counter)
    Button tweetButton;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        lookup.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false));
    ...
    @OnClick(R.id.character_counter)
    void onTweet() {
    ...
    private static class LookupAdapter extends RecyclerView.Adapter<UserView> {
        ...
        public UserView onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new UserView(LayoutInflater.from(parent.getContext()).inflate(R.layout.dialog_user, parent, false));
        }
