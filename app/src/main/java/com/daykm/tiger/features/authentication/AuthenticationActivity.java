...
public class AuthenticationActivity extends BaseActivity implements TwitterWebViewClient.Callbacks {
    ...
    public void onCallback(final String url) {
        ...
        final TwitterServiceCredentials creds = realm.where(TwitterServiceCredentials.class).findFirst();
            ...
            public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.code() == 200) {
                    ...
                    try {
                        ...
                        final TwitterServiceCredentials tempCreds = realm.where(TwitterServiceCredentials.class).findFirst();
